...
export default function NotePreview({ note, category, onBack, onEdit }: NotePreviewProps) {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="prose prose-sm max-w-none min-h-96 p-4 border border-gray-200 rounded-lg bg-gray-50">
        {note.content ? (
          <ReactMarkdown 
          ...
          <div className="text-gray-500 italic text-center py-12">
            Aucun contenu. Cliquez sur &quot;Modifier&quot; pour commencer à écrire.
          </div>
        )}
      </div>
    </div>
